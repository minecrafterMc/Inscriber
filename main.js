...
function readCustomCards()
{
  ...
  while (i != customCardAmmount)
  {
    ...
    cards[i].rare = document.getElementById("CardRare" + i).checked;
    cards[i].banned = document.getElementById("CardBanned" + i).checked;
    cards[i].nosac = document.getElementById("CardNoSac" + i).checked;
    i += 1;
  }
  return cards;
}
